...
const stack = [
  { project: projects[0], className: 'hero-product firelinehero', label: 'Incident intelligence', factor: 1 },
  { project: projects[1], className: 'hero-product aerolearnhero', label: 'Operational learning', factor: .7 },
  { project: projects[2], className: 'hero-product aerofleethero', label: 'Fleet readiness', factor: .58 },
]
  ...
  return (
    <div ref={ref} className="hero-product-stack" onPointerMove={onPointerMove} onPointerLeave={reset}>
      ...
      <motion.div
        ...
        transition={{ duration: .72, delay: .7 }}
      >
        <span>03</span>
        <div><b>Interactive product systems</b><small>Real software flows · synthetic aviation data</small></div>
      </motion.div>
    </div>
  )
}
